...
class _MapScreenState extends State<MapScreen> {
  ...
  static const Point _chechenRepublicCenter =
      Point(latitude: 43.3169, longitude: 44.6981);

  MapWindow? _mapWindow;
  bool _showList = true; // Переключатель между картой и списком
  ...
  final List<CulturalPlace> _places = [
    CulturalPlace(
      ...
      location: const Point(latitude: 43.304078, longitude: 45.503248),
